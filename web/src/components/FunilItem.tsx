...
export default function FunilItem({ name, index }: FunilItemProps) {
  ...
  return (
    <div className="w-full flex flex-col gap-8">
      <SimpleList
        ...
        hasDeleteIcon={false}
        itemPlaceholder="Funil"
        bothTextAreaPlaceholder="Sobre o funil"
      />
                    ...
                    <FormItem className="w-80">
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="Video Longo">
                            Video Longo
                          </SelectItem>
                          <SelectItem value="Video Curto">
                            Video Curto
                          </SelectItem>
                        </SelectContent>
                      </Select>
