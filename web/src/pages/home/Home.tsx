...
export default function Home() {
  ...
  const [showEmptyClients, setShowEmptyClients] = useState<boolean>(false)
  ...
  useEffect(() => {
    ...
    if (dados?.apresentacao.length === 0 && !!dados?.clientsCount) {
      setShowEmptyClients(true)
    } else {
      setClientsCount(dados?.clientsCount || dados?.apresentacao.length || 0)
      setShowEmptyClients(false)
    }
  }, [data])
